...
- `notas/` — anotações pessoais gerais.

Use arquivos Markdown para informações que a Hermes deve consultar. Use PDFs ou imagens apenas quando forem documentos de referência.
